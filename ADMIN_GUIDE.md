...
| **Mohon Temujanji** | Students who asked to see a counsellor, plus how many declined the offer |
...
Directly below the cards. Each card is one student who scored **Sederhana or above**
(or tripped the crisis flag), was offered an appointment, chose "Ya, saya berminat",
and consented to their details being shared with the Unit Kaunseling.

| Field | Notes |
|-------|-------|
| **Nama** | Cards with a red **Krisis** badge are highlighted — contact these first |
| **No. Pendaftaran / Kelas / Jabatan** | For locating the student's records |
| **Telefon / E-mel** | Click to dial or compose |
| **Waktu sesuai** | Their preferred contact window, if given |
| Quoted note | What the student said they want to discuss, if given |
| Score line | Stres / Anzieti / Kemurungan raw score + band at the time they applied |

Students who chose "Tidak, terima kasih" are counted in the stat card but appear
nowhere in this list — that row is stored without any identifying columns, and the
database enforces it.

This list is the only place identifying data ever appears. Treat it as a
confidential counselling record.

---

## The Results Table

Below the referral worklist, a table of the **100 most recent screenings**
(anonymous, including students who never saw or never accepted the offer):
